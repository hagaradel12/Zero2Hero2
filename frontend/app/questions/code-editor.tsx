...
// }
// ========================================
// 1. CodeEditor.tsx - Updated with popup and redirect
// ========================================
// ========================================
// FILE: nextjs-frontend/components/CodeEditor.tsx
// PURPOSE: Code editor with finish popup
// CHANGES: Added levelId prop, finish popup, and redirect to Phaser
// ========================================
// ========================================
// FILE: nextjs-frontend/components/CodeEditor.tsx
// PURPOSE: Code editor with proper scene redirect
// CHANGES: Updated redirect to pass level parameter correctly
// ========================================
...
export default function CodeEditor({
  ...
  // ========================================
  // 🎮 RETURN TO PHASER - CLEAN URL REDIRECT
  // ========================================
const handleReturnToScene = () => {
  // ✅ Navigate to internal Next.js route without full reload
